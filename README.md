...
This repository contains all experiments conducted as part of the **Mobile Application Development (MAD) Lab**. Each experiment focuses on a specific type of Android app development.
...
Select the experiment folder you want to run
